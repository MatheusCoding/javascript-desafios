...
*/
console.log( '\nInversed Name:' );
var inversedName = nome.reduceRight(function(previousValue, currentValue){
...
result = numberObjects.lastIndexOf(numberObjects[1])    
console.log(result)
if (result !== -1){
    console.log('Existe um objeto { number: 2 } em numberObjects!')    
} else {
...
var check = Array.isArray(justMod2Or3);
console.log(check)
if (check){
